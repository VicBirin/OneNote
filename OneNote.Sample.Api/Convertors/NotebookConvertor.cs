...
{
    public class NotebookConvertor
    {
        public Microsoft.Graph.Notebook ConvertToOneNote(Notebook src)
        {
            var sectionConvertor = new SectionConvertor();
        ...
        public Notebook ConvertToLocal(Microsoft.Graph.Notebook src)
        {
            ...
            dest.Sections = src.Sections == null ? new List<Section>() : src.Sections.Select(s => sectionConvertor.ConvertToLocal(s, dest)).ToList();
